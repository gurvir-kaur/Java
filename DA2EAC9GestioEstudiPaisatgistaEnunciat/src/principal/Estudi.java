...
public class Estudi implements Component {
 ...
 /*
     ...
     Retorn: cap
     */
    public void addDissenyador(Dissenyador nouDissenyador) {

        if (nouDissenyador == null) {
            components.add(Dissenyador.addDissenyador());
        } else {
 ...
 /*
    ...
    public void addJardiner(Jardiner jardiner) {
        ...
        if (jardiner == null) {
            components.add(Jardiner.addJardiner());
        } else {
 ...
 /*
    ...
    public void addProjecte(Projecte projecte) {
        ...
        if (projecte == null) {
            components.add(Projecte.addProjecte());
        } else {
    ...
    // añadir throws GestorEstudisException
    public void addTornJardiner() throws GestorEstudisException {
        ...
        if (pos >= 0) {
            ...
            jardiner = (Jardiner) this.getComponents().get(pos);

            pos = selectComponent(3, null);

            if (pos >= 0) {

                if (((Jardiner) getComponents().get(pos)).getTorn() == null) {
                    ((Jardiner) getComponents().get(pos)).setTorn(Torn.addTorn());
                } 
                else {
